...
from tarla_ai.ui.html import fmt, section_head
...
def _metric_grid(items: list[tuple[str, str]]) -> None:
    cols = "".join(
        f'<div><div style="font-size:11px;opacity:0.5;margin-bottom:4px">{label}</div>'
